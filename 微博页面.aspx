<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="微博页面.aspx.cs" Inherits="微博页面" MaintainScrollPositionOnPostback=true SmartNavigation=true %>
...
<body>
    <form id="form1" runat="server">
        <div id="all" runat="server">
            <asp:GridView ID="GridView1" runat="server" align="top" AllowPaging="True" AutoGenerateColumns="False" CaptionAlign="Top" HorizontalAlign="Left" ShowHeader="False" GridLines="None" Width="550px" OnPageIndexChanging="GridView1_PageIndexChanging" OnLoad="GridView1_Load" PageSize="5">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <table class="auto-style12">
                                ...
                                <tr>
                                    <td class="auto-style22" colspan="4">
                                        <asp:Panel ID="Panel3" runat="server" BackColor="White" Width="517px">
                                            <asp:Label ID="showpost" runat="server" style="word-break:break-all;" Width="519px"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style23">
                                        <asp:Button ID="del" runat="server" OnClick="Button14_Click" Visible="False" style="height: 21px" />
                                    </td>
                                </tr>
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false" Height="50px" Width="100%">      
                                    ...
                                    <tr>
                                        <td valign="top" class="auto-style27"></td>
                                        ...
                                        <td class="auto-style27">
                                            <asp:Button ID="Button15" runat="server" BackColor="#FF3399" BorderStyle="None" OnClick="Button15_Click" Text="评论" Width="40px" />
                                        </td>
                                    </tr>
                          </asp:Panel>
